                                        ...
                                        <tbody>
                                            ...
                                            <?php while($row = $stmt->fetch(PDO::FETCH_ASSOC)): ?>
                                                <tr>
                                                    ...
                                                    <td class="truncate-text"><a href="postDetail.php?post_id=<?= $row['post_id'] ?>" style="text-decoration: none;"><?= $row['post_id'] ?></a></td>
                                                    <td><?= $row['user_id'] ?></td>
                                                    <td><?= $row['com_date'] ?></td>

                                                    <td>
                                                        <button type="button" class="btn btn-success btn-sm px-2" data-bs-toggle="modal" data-bs-target="#editModal<?= $row['comment_id'] ?>">
                                                            <i class="fa-solid fa-pen-to-square"></i>
                                                        </button>
                                                        <button type="button" class="btn btn-danger btn-sm px-2" data-bs-toggle="modal" data-bs-target="#deleteModal<?= $row['comment_id'] ?>">
                                                            <i class="fa-solid fa-trash"></i>
                                                        </button>
